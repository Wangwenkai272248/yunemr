...
import jhmk.clinic.core.util.MapUtil;
...
public class MenzhenRule implements Serializable {
    ...
    private Mzbinganshouye mzbinganshouye;
    ...
    public Mzbinganshouye getMzbinganshouye() {
        return mzbinganshouye;
    }

    public void setMzbinganshouye(final Mzbinganshouye mzbinganshouye) {
        this.mzbinganshouye = mzbinganshouye;
    }
    ...
    public static MenzhenRule fill(JSONObject jo) {
        MenzhenRule o = new MenzhenRule();
