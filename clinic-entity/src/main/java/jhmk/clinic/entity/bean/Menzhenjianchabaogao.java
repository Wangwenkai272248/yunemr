...
public class Menzhenjianchabaogao implements Serializable {
    ...
    public void setStandard_name(final String standard_name) {
        this.standard_name = standard_name;
    }

    public String getExam_class_name() {
        return exam_class_name;
    }

    public void setExam_class_name(final String exam_class_name) {
        this.exam_class_name = exam_class_name;
    }
}
